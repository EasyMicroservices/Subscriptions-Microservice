...
namespace EasyMicroservices.SubscriptionsMicroservice.Clients.Tests
{
...
{""result"":[],""isSuccess"":true,""error"":null}");
        ...
        {
            //await OnInitialize();
            //var microserviceClient = new Subscriptions.GeneratedServices.MicroserviceClient(_routeAddress, HttpClient);
